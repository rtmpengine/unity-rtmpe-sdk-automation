...
Client                                    Gateway (Rust)
  │                                           │
  │── HandshakeInit (0x05) ──────────────────▶│
  │   API key sealed to the gateway X25519    │  DB lookup: SHA-256(key)
  │   [eph_pub:32][ct+tag:N]  (≥ 82 bytes)    │
  │                                           │
  │◀─ Challenge (0x06) ──────────────────────│
...
*RTMPE SDK 2.0.21 — [Getting Started](getting-started.md) — [Protocol Reference](protocol.md) — [API Reference](api/index.md)*
