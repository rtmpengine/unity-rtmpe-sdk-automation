...
namespace RTMPE.Tests
{
    ...
    public class ServerKeyPinningTests
    {
        ...
        public void Tofu_FirstConnect_PersistFirstUse_WritesPin()
        {
            ...
            bool wrote = ServerKeyPinning.PersistFirstUse(r, store, observed, out _);
            Assert.IsTrue(wrote);
        ...
        public void Tofu_SecondConnect_SameKey_ProceedsWithPersistedPin()
        {
            ...
            var r1 = ServerKeyPinning.PreparePin(
                ServerPinningMode.TrustOnFirstUse, null, store, "h", 1);
            ServerKeyPinning.PersistFirstUse(r1, store, observed, out _);
        ...
        public void Tofu_SecondConnect_PersistFirstUse_DoesNotOverwrite()
        {
            ...
            var r1 = ServerKeyPinning.PreparePin(
                ServerPinningMode.TrustOnFirstUse, null, store, "h", 1);
            ServerKeyPinning.PersistFirstUse(r1, store, firstObserved, out _);
            ...
            bool wrote = ServerKeyPinning.PersistFirstUse(r2, store, Pin(0x99), out _);
        ...
        public void InsecureNoPinning_NeverPersists()
        {
            ...
            ServerKeyPinning.PersistFirstUse(r, store, Pin(0x11), out _);
        ...
        public void PersistFirstUse_RejectsWrongLengthKey()
        {
            ...
            Assert.IsFalse(ServerKeyPinning.PersistFirstUse(r, store, new byte[31], out _));
            Assert.IsFalse(ServerKeyPinning.PersistFirstUse(r, store, null, out _));
            Assert.AreEqual(0, store.SaveCalls);
        }
        ...
        public void PersistFirstUse_NoOpForNonCaptureDecisions()
        {
            ...
            Assert.IsFalse(ServerKeyPinning.PersistFirstUse(rStrict, store, Pin(0x77), out _));

            var rUnpinned = new PinResolution(PinDecision.ProceedUnpinned, null, "h:1");
            Assert.IsFalse(ServerKeyPinning.PersistFirstUse(rUnpinned, store, Pin(0x77), out _));

            var rRefuse = new PinResolution(PinDecision.RefuseStrictNoPin, null, "h:1");
            Assert.IsFalse(ServerKeyPinning.PersistFirstUse(rRefuse, store, Pin(0x77), out _));
