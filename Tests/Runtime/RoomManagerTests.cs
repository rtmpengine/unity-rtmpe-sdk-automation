...
namespace RTMPE.Tests
{
    ...
    public class RoomManagerTests
    {
        ...
        public void HandleJoinResponse_Failure_FiresOnRoomError()
        {
            ...
            // The failure is reported for a join this client is waiting on. A
            // reply with nothing outstanding is the duplicate that follows a
            // retransmit, and HandleJoinResponse deliberately stays silent for
            // it so one lost request does not raise two errors.
            _roomManager.JoinRoom("room-J");
            _sentPackets.Clear();
