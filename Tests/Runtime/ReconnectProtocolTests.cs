...
namespace RTMPE.Tests
{
    ...
    public class ReconnectProtocolTests
    {
        ...
        public void BuildReconnectInit_EmitsTokenLengthPrefixedPayload()
        {
            ...
            byte[] packet = builder.BuildReconnectInitWithoutProof(token, new byte[32]);
        ...
        {
            var builder = new PacketBuilder();
            byte[] a = builder.BuildReconnectInitWithoutProof("tok-a", new byte[32]);
            byte[] b = builder.BuildReconnectInitWithoutProof("tok-b", new byte[32]);
        ...
        {
            var builder = new PacketBuilder();
            Assert.Throws<ArgumentException>(() => builder.BuildReconnectInitWithoutProof(null, new byte[32]));
        }
        ...
        {
            var builder = new PacketBuilder();
            Assert.Throws<ArgumentException>(() => builder.BuildReconnectInitWithoutProof("", new byte[32]));
        }
        ...
        public void BuildReconnectInit_Rejects_TokenLongerThan128Bytes()
        {
            ...
            Assert.Throws<ArgumentException>(() => builder.BuildReconnectInitWithoutProof(huge, new byte[32]));
        }
        ...
        public void BuildReconnectInit_Accepts_TokenAtExactly128Bytes()
        {
            ...
            Assert.DoesNotThrow(() => builder.BuildReconnectInitWithoutProof(atLimit, new byte[32]),
