...
namespace RTMPE.Tests
{
    ...
    public class Tier1RebindTests
    {
        ...
        public void SetUp()
        {
            // RequireInRoom admits a property write only from InRoom with a
            // current room, so a fixture held at Connected measures the guard
            // and not the routing these cases are about.
        ...
        public void SceneManager_DoubleRebind_DoesNotDoubleFire()
        {
            ...
            // Each write the room accepts is announced, and this one names a
            // scene of its own.  A rebind carries no memory of what the
            // previous manager had displayed, so the application is the party
            // that decides whether a name it is already on is worth acting on —
            // CurrentScene is exposed for exactly that.
