...
namespace RTMPE.Tests
{
    ...
    public class ReconnectionTests
    {
        ...
        public void SendAfterDispose_ThrowsInvalidOperation()
        {
            ...
            // ObjectDisposedException, not InvalidOperationException: a disposed
            // transport names its state, and HygieneSprintTests pins the same
            // exception for the same call — two files had asserted two answers.
            Assert.Throws<ObjectDisposedException>(() => t.Send(new byte[] { 1 }),
