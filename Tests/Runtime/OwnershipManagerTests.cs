...
namespace RTMPE.Tests
{
    ...
    public class OwnershipManagerTests
    {
        ...
        public void RequestOwnershipTransfer_EmptyNewOwner_IsRejected()
        {
            ...
            // An empty target is a contract violation rather than a runtime
            // condition, and is surfaced as an ArgumentException so the stack
            // trace points at the call site — a log line is missed in a CI run
            // and filtered out of a release build.
            Assert.Throws<System.ArgumentException>(
                () => _ownership.RequestOwnershipTransfer(22UL, string.Empty));
