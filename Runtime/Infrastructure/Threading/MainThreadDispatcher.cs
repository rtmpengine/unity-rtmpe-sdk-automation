...
namespace RTMPE.Threading
{
    ...
    public sealed class MainThreadDispatcher : MonoBehaviour
    {
        ...
        /// <summary>
        /// Whether the main thread has been identified yet.  <see cref="IsMainThread"/>
        /// answers <see langword="false"/> both for "another thread" and for
        /// "not yet known", and a caller reporting a threading mistake has to
        /// tell those apart — the second is not a mistake, and outside a Unity
        /// player (headless tools, tests) it is the normal state.
        /// </summary>
