...
namespace RTMPE.Rooms
{
    ...
    public sealed class PlayerInfo
    {
        ...
        /// </summary>
        /// <remarks>
        /// This REPLACES the map wholesale, exactly as
        /// <see cref="RoomInfo.WithProperties"/> does.  A caller applying a
        /// broadcast is applying a delta and must merge it first — see
        /// <see cref="RoomInfo.MergeProperties"/>, which is what RoomManager
        /// does on both paths.  Stated here as well as there: this is the
        /// overload the player broadcast actually calls, and a warning that
        /// lives only on the other type is a warning the reader of this one
        /// never sees.
        /// </remarks>
