...
namespace RTMPE.Rooms
{
    ...
    public sealed class RoomInfo
    {
        ...
        /// </summary>
        /// <remarks>
        /// This REPLACES the map wholesale.  A caller applying a broadcast is
        /// applying a delta and must merge it first — see
        /// <see cref="MergeProperties"/>, which is what RoomManager does.
        /// </remarks>
