    ...
    public sealed partial class NetworkManager
    {
       ...
       /// 1. Parse 128-byte payload: [ephemeral:32][static:32][sig:64].
        ...
        private void OnChallenge(byte[] data)
        {
            ...
            // The gateway never re-sends a Challenge, so a repeat is UDP
            // duplication or an on-path replay of the genuine frame, and it
            // carries nothing the first pass did not already act on.
            //
           ...
           // Trust-On-First-Use captures the static key after — never before —
                    ...
                    resolution.PinToEnforce))
            {
                ...
                // missing-envelope fail-fast paths.
                FailHandshake(
