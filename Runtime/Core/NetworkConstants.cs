...
namespace RTMPE.Core
{
    ...
    public static class PacketProtocol
    {
        ...
        /// <summary>
        /// Current protocol version byte. Must match gateway constant <c>VERSION = 4</c>.
        ...
        /// no signal back to the sender. Refusing the header is where the
    ...
    /// <c>modules/gateway/src/nats/forwarder.rs</c> (CLAUDE.md rule 1).</para>
    /// </summary>
