    ...
    public sealed partial class NetworkManager
    {
        ...
        private static void ResetStaticState()
        {
            lock (_instLock)
            {
                ...
                // so unlike a per-object latch it can never re-arm on its own as
                // new ids are minted.  Without this, a developer who corrects the
                // configuration and re-enters Play with domain reload disabled
                // sees silence whether they fixed it or not.
