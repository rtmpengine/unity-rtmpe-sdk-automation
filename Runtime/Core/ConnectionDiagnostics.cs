            ...
            int elapsedMs)
        {
            ...
            string guidance = stage switch
            {
                ...
                ConnectionFailureStage.HandshakeInitNotSent =>
                    ...
                    "on the NetworkSettings asset used by this build).",
                ConnectionFailureStage.NoServerReply =>
                    ...
                    "received the packet but silently dropped it because the box was sealed to a " +
                    "key it holds no scalar for; check apiKeySealServerPublicKeyHex in " +
                    "NetworkSettings and confirm the gateway logs show no crypto-reject events.",
