...
namespace RTMPE.Core
{
    ...
    public static class ObjectIdMath
    {
        ...
        /// <summary>
        /// Whether <paramref name="objectId"/> was minted inside
        /// <paramref name="sessionId"/>'s own id space.
        /// </summary>
        /// <remarks>
        /// Only the high half is read.  The counter is the session's own
        /// business: a client may reach any value in it, in any order, and
        /// skipping or repeating one is a question for the object registry
        /// rather than for this rule.
        /// <para>
        /// The gateway asks the same question of a spawn it is about to record,
        /// and the two implementations are held byte-identical by
        /// <c>scripts/check-object-id-digest-parity.sh</c>.  A receiver asks it
        /// the other way round — whether an id it is being told about lies in
        /// its <em>own</em> space — because that is the one partition a client
        /// can decide alone, without knowing any other session's id.
        /// </para>
        /// </remarks>
