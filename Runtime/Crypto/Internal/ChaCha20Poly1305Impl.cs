...
//
// Used in two places:
//   1. SealedApiKeyCipher: seal the API key in HandshakeInit under the key
//      agreed with the gateway's static X25519 public key.
...
namespace RTMPE.Crypto.Internal
{
    ...
    internal static class ChaCha20Poly1305Impl
    {
        ...
        public static byte[] Seal(byte[] key, byte[] nonce, byte[] plaintext, byte[] aad)
        {
            ...
            // contract for callers (handshake, tests, SealedApiKeyCipher) while
